...
PHP_FUNCTION(confirm_extdemo_compiled)
{
	...
	strg = strpprintf(0, "Congratulations! You have successfully modified ext/%.78s/config.m4. Module %.78s is now compiled into PHP.", "extdemo", arg);
...
{
#if defined(COMPILE_DL_EXTDEMO) && defined(ZTS)
